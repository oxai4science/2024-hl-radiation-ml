...
def main():
    ...
    parser.add_argument('--test_event_id', nargs='+', default=['biosentinel01', 'biosentinel18', 'biosentinel19'], help='Test event IDs')
    parser.add_argument('--test_seen_event_id', nargs='+', default=['biosentinel04', 'biosentinel15', 'biosentinel07'], help='Test event IDs seen during training')
    ...
    with Tee(log_file):
        ...
        if args.mode == 'train':
            ...
            if args.model_type == 'RadRecurrentWithSDO':
                dataset_sequences_train = Sequences([dataset_sdo, dataset_goes_xrs, dataset_biosentinel], delta_minutes=args.delta_minutes, sequence_length=training_sequence_length)
            else:
